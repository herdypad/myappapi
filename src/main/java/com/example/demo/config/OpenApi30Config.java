	  ...
	  private ApiInfo metadata() {
	    return new ApiInfoBuilder()//
	        ...
	        .description(""
	        		...
	        		+ "Once you have successfully logged in and obtained the token, you should click on the right top button `Authorize` and introduce it with the "
	        		+ "prefix \"Bearer \".")//
	        .version("1.0.0")//
	        .license("MIT License").licenseUrl("http://opensource.org/licenses/MIT")//
	        .contact(new Contact(null, null, "herdypad@gmail.com"))//
	        .build();
	  }
